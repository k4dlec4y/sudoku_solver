 ...
 * @param row     starting from 0 (leftmost) to 8 (rightmost)
 */
 ...
 *
 * @param sudoku  2D array of digit bitsets
 * @param col     starting from 0 (top) to 8 (bottom)
 */
...
/**
 * @brief  Check if the sudoku is to be solved yet, or is already complete.
 *
 ...
 *
 * If the sudoku is fully solved, return true, otherwise false.
 *
 * @param sudoku  2D array of digit bitsets
 */
